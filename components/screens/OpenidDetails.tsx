...
type OpenIDDetailsScreenNavigationProps = StackScreenProps<
  RootStackParamList,
  'OpenidDetails'
>;
...
export class OpenIDDetailsScreen extends React.Component<
  OpenIDDetailsScreenProps,
  {}
> {
    ...
    return (
      <Animated.View style={{opacity}}>
        ...
        <NavBar
          ...
          left={() => <Text style={styles.title}>OpenID Details</Text>}
        />
      </Animated.View>
    );
  }
  ...
  render() {
    return (
      <View style={styles.mainView}>
        ...
        <ObjectTable obj={NhsLogin.instance.nhsIdTokenPayload} />
      </View>
    );
  }
}
