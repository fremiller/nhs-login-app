...
type LoginWebviewScreenNavigationProps = StackScreenProps<
  RootStackParamList,
  'LoginWebview'
>;
...
export class LoginWebviewScreen extends React.Component<
  LoginWebviewScreenProps,
  {}
> {
    ...
    return (
      <Animated.View style={{opacity}}>
        ...
        <NavBar
          ...
          left={() => <Text style={styles.title}>Log In</Text>}
        />
      </Animated.View>
    );
  }
