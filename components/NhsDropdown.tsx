...
export class NhsDropdown extends React.Component<
  NhsDropdownProps,
  NhsDropdownState
> {
    ...
    return (
      <>
        <TouchableWithoutFeedback
          ...
          <View style={components.picker}>
            <Text style={components.pickerText}>
              {
                this.props.items.find((v) => v.value == this.props.currentValue)
                  ?.label
              }
            </Text>
            <Chevron height="40%" width="10%" />
          </View>
        </TouchableWithoutFeedback>
        <Modal
          animationType="fade"
